### 15.0.2 (2024-12-02)
### Bug Fixes
* **Report on demand:** Protected the preview button from multiple clicks ([](https://github.com/OntimizeWeb/ontimize-web-ngx-report/commit/)) Closes [#241](https://github.com/OntimizeWeb/ontimize-web-ngx-report/issues/241)
